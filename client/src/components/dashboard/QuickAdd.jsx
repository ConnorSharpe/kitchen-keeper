...
export default function QuickAdd() {
  ...
  return (
    <div className="card p-4">
      <h2 className="text-sm font-semibold text-ink-muted mb-3">Quick Add</h2>
      <form
      ...
      >
        ...
        <label className="flex flex-col gap-0.5 flex-shrink-0">
          <span className="text-xs text-ink-subtle leading-none">Category</span>
          <select
            value={category}
        ...
        <label className="flex flex-col gap-0.5 flex-shrink-0">
          <span className="text-xs text-ink-subtle leading-none">Expires</span>
          <input
            type="date"
            value={expiryDate}
