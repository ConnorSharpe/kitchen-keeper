...
const CATEGORY_RULES = [
  {
    keywords: ['dairy', 'milk', 'cheese', 'yogurt', 'cream'],
    category: 'Dairy',
  },
  { keywords: ['produce', 'vegetable', 'fruit', 'fresh'], category: 'Produce' },
  {
    keywords: ['seafood', 'fish', 'shellfish', 'shrimp', 'prawn'],
    category: 'Seafood',
  },
  {
    keywords: ['meat', 'poultry', 'chicken', 'beef', 'pork', 'lamb'],
    category: 'Meat',
  },
  {
    keywords: ['bakery', 'bread', 'pastry', 'biscuit', 'cake'],
    category: 'Bakery',
  },
  { keywords: ['frozen'], category: 'Frozen' },
  {
    keywords: ['beverage', 'drink', 'juice', 'water', 'soda', 'tea', 'coffee'],
    category: 'Beverages',
  },
  {
    keywords: ['condiment', 'sauce', 'dressing', 'vinegar', 'oil'],
    category: 'Condiments',
  },
];
